...
/**
 * This class represents a generic breakfast food.
 *
 */
public class BreakfastObject extends FoodObject {
	
	/**
	 * Breakfast object constructor.
	 * 
	 ...
	 */
	public BreakfastObject(boolean containsPeanuts, boolean containsEggs, boolean containsMilk, boolean containsSoy, boolean containsFish, boolean containsShellfish, String foodName, int calories, String url) {
