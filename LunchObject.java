/**
 *
 * This class represents a generic lunch food.
 *
 */
public class LunchObject extends FoodObject {
	/**
	 * Lunch object constructor.
	 * 
	 ...
	 */
	public LunchObject(boolean containsPeanuts, boolean containsEggs, boolean containsMilk, boolean containsSoy, boolean containsFish, boolean containsShellfish, String foodName, int calories, String url) {
